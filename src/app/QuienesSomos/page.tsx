...
export const metadata: Metadata = {
  title: 'Moto Store LLC | Soluciones Digitales 24/7', // <-- ¡CAMBIADO AQUÍ PARA EL TÍTULO DE LA PESTAÑA!
  description: 'Conoce a Moto Store LLC, nuestro compromiso, misión y visión en soluciones digitales 24/7.', 
};
    ...
    <div className="p-4 md:p-10 rounded-lg text-gray-700 bg-white">
      <div className={`grid grid-cols-1 md:grid-cols-2 gap-10 py-8`}>
        ...
        <div className="order-1 py-4">
          {/* ESTE ES EL TÍTULO VISIBLE DENTRO DE LA PÁGINA */}
