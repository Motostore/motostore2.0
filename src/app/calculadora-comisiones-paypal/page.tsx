...
export default function Page() {
  ...
  return (
    <>
      ...
      <Head>
        <title>Calculadora de Comisiones PayPal Actualizada 2025</title>
        <meta
          name="description"
          content="Calcula rápidamente cuánto debes enviar o cuánto recibirás en PayPal considerando comisiones actualizadas."
        />
      </Head>
      ...
      <div className="w-full min-h-screen flex items-center justify-center bg-gray-100 px-4 py-16 md:py-32">
        <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-6 md:p-10 flex flex-col items-center gap-6">
          ...
          <div className="bg-gray-50 border border-gray-200 text-gray-700 px-4 py-4 rounded mt-6 text-sm leading-tight md:px-6 md:py-6 md:text-base md:leading-relaxed text-justify">
            ...
            <p className="mt-2">
              Por defecto colocamos los valores estándar de las comisiones de PayPal que son <strong>5,4%</strong> + un fijo de <strong>0,3 USD</strong> por transacción(*). Revisa si tu país tiene una comisión distinta y colócala de forma manual.
            </p>
            <p className="mt-3 font-semibold">¿Monto Bruto y Monto Neto?</p>
            <p>
              El monto <strong>bruto</strong> es el dinero enviado sin contar ningún tipo de comisión.
            </p>
            <p className="mt-1">
              <em>Ejemplo:</em> Si te envían <strong>10 USD brutos</strong>, recibirás solo <strong>9,16 USD netos</strong>.
            </p>
            <p className="mt-2">
              El monto <strong>neto</strong> es lo que realmente recibes tras aplicar comisiones.
            </p>
            <p className="mt-1">
              <em>Ejemplo:</em> Para recibir <strong>10 USD netos</strong>, deben enviarte <strong>10,89 USD brutos</strong>.
            </p>
            <p className="mt-3 italic text-[11px] text-gray-500 md:text-xs">
              *Importante: Esta calculadora no incluye comisiones por servicios externos.
            </p>
          </div>
        </div>
      </div>
