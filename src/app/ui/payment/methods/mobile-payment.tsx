...
export default function MobilePayment({ 
  ...
  // Mantener sincronizado el payload con el padre
  useEffect(() => {
  ...
  return (
    <>
      <div className="col-span-2 flex flex-col justify-between border-r-2 border-gray-300 pr-6">
        <div>
          <h5 className="font-bold text-lg text-gray-600 mb-2">Pago mediante pago móvil</h5>
          <div className="flex flex-col items-center justify-center p-2 border-2 border-green-300 rounded-lg">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => setPayload(mercantil)}
                className="py-2 px-4 rounded-lg bg-blue-600 hover:bg-blue-800 text-white font-bold"
              >
                Mercantil
              </button>
              <button
                onClick={() => setPayload(banesco)}
                className="py-2 px-4 rounded-lg bg-green-400 hover:bg-green-600 text-white font-bold"
              >
                Banesco
              </button>
            </div>
