...
import { fetchPagedProductsByType, fetchDeleteProduct } from "@/app/lib/products.service";
...
export default function Table(
  ...
  const openModalTrigger = (data) => {
    setContent({
      ...
      body: `¿Estás seguro que quieres eliminar la licencia ${data.user}?`,
      target: data.id,
                ...
                <div className="flex items-start justify-between border-b pb-2 gap-2">
                  <div>
                    <div className="mb-2 flex items-center">
                      <p>
                        <strong>Licencia:</strong> {item.provider?.name}
                      </p>
                    </div>
                  </div>
                ...
                <div className=" w-full pt-4">
                  <div>
                    ...
                    <p>
                      ...
                      {formatCurrency(item.provider?.price )}
                    </p>
                    <p>
                      <strong>Duracion: </strong>
                      {pluralizeMonth(item.provider?.duration)}
                    </p>
